...
<a href="https://www.codecogs.com/eqnedit.php?latex=\forall&space;x,y,z,d(x,y)\leq&space;max\{d(x,z),d(y,z)\}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\forall&space;x,y,z,d(x,y)\leq&space;max\{d(x,z),d(y,z)\}" title="\forall x,y,z,d(x,y)\leq max\{d(x,z),d(y,z)\}" /></a>
